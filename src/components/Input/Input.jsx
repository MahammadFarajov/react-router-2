...
function Input( {label, value, onChange, type, onBlur, error} ) {
  return (
    <div>
        <div className="relative mt-4">
            <input onChange={onChange} value={value} type={type} placeholder='' name={label.toLowerCase()} id={label.toLowerCase()} className={`border pl-4 peer rounded-lg h-14 pt-1.5 font-medium focus-visible:outline-none w-full ${error ? "!border-red-500" : ""} `}/>
